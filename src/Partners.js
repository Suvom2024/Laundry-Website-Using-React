    ...
    return (
      <div className="page-title">
        ...
        <div className="link">
          ...
          <span className="page">Partners</span>
        </div>
      </div>
    );
  };
    ...
    return (
      <section className="partners">
        ...
        <div className="box-container">
          <div className="partner-item"><a href="#"><img src="./partner-1.png" alt="Partner-Image" /></a></div>
          <div className="partner-item"><a href="#"><img src="./partner-2.png" alt="Partner-Image" /></a></div>
          <div className="partner-item"><a href="#"><img src="./partner-3.png" alt="Partner-Image" /></a></div>
          <div className="partner-item"><a href="#"><img src="./partner-4.png" alt="Partner-Image" /></a></div>
          <div className="partner-item"><a href="#"><img src="./partner-5.png" alt="Partner-Image" /></a></div>
          <div className="partner-item"><a href="#"><img src="./partner-6.png" alt="Partner-Image" /></a></div>
          <div className="partner-item"><a href="#"><img src="./partner-7.png" alt="Partner-Image" /></a></div>
          <div className="partner-item"><a href="#"><img src="./partner-8.png" alt="Partner-Image" /></a></div>
          <div className="partner-item"><a href="#"><img src="./partner-9.png" alt="Partner-Image" /></a></div>
          <div className="partner-item"><a href="#"><img src="./partner-10.png" alt="Partner-Image" /></a></div>
        </div>
      </section>
    );
  };
